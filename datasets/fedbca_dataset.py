...
class FedBCaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # use_cls_loss: ONLY best slice per patient
        # Best slice has max tumor area = most diagnostically representative
        # Using all tumor slices adds noisy labels from partial/blurry views
        use_cls = int(is_best)
